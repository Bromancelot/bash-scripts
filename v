...
#FONT="xft:Go Mono:size=11:antialias=true"
#BG="black" 
BG="#282828"
FG="#55ff55"

exec /usr/local/bin/xterm -geometry 85x43 -bg "$BG" -fg "$FG" -cr red -fa "$FONT" -tn xterm-265color -vb -sb +bc -name Vim -e vim "+colors monow" "${@}" &
